...
def gerarordem(cpreta,cbrancas,claranja,croxo):
    ordem = []
    contp , contb , contl ,contr = 1,7,9,8
    while contp!=0 or contb!=0 or contl!=0 or contr!=0:
        ...
        if a==0 and contp != 0:
            ...
            c = Carta(cbrancas[contb-1],'branco')
            ordem.append(c)
            contb -= 1
...
def main_doistimes():
    ...
    fontgrande = pygame.font.SysFont('Arial',90)
    BLUE=(0,0,255)
    VERDE = (127,255,212)
    screen.fill(BEGE)
    ...
    pygame.draw.rect(screen,BEGE,(janelaw-220,30,200,100))
    screen.blit(placar1,(janelaw-220,30))
    screen.blit(placarx,(janelaw-160,30))
    screen.blit(placar2,(janelaw-100,30))
    botaoLaranja= Button(janelaw - 220, 150, LARANJA)
    botaoRoxo= Button(janelaw - 110, 150, ROXO)
    ...
    while run:
        ...
        for event in pygame.event.get():
                        ...
                        if lista[y][x].click((a,b)):
                            if(lista[y][x].cor=='laranja' and lista[y][x].estado == 'fechado') :
                                ...
                                if vez:
                                    ...
                                    temporizador = VEZ
                                lista[y][x].estado = 'aberto'
                            elif (lista[y][x].cor=='branco' and lista[y][x].estado=='fechado'):
                                lista[y][x].estado = 'aberto'
                                if not vez:
                                    vez = True
                                    temporizador = VEZ
                                    ...
                                    vez = False
                                    temporizador = VEZ
                            if(lista[y][x].getCor()==(0,0,0) or proxo == 0 or plaranja == 0):
                                jogo = False
            ...
            pygame.draw.rect(screen, BEGE, (janelaw - 220, 250, 200, 100))
